    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="presentation" class="col-sm-12   col-md-6 offset-md-3  col-lg-6 offset-lg-3 ">
                ...
                <p>
                    Développeur web full stack. Je conçois des applications web et mobile. Je travaille quotidiennement avec des langages tels que : HTML, CSS, Javascript, PHP et le framework Symfony . Vous êtes intéressé) par mon profil ? Contactez-moi via le formulaire en bas de page.
                </p>
        ...
        <div class="container " id="projets">
            <div class="row ">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 ">
                    <img class="card-img-top " src="ressources/dashboard.png" alt="Card image cap ">
                    <div class="card-body ">
                        <h2>PWA Vigitek</h2>
                        <p class="card-text ">Système de gestion dédié aux entreprises de sécurité.
                        (Prise et fin de service, Main courante électronique, Edition de rapports, Création de consignes, Messagerie interne)</br>
                        <small><b>Projet développé avec Symfony 6</b></small>
                        </p>
                        <a href="https://vigitek.fr/" target="_blank" class="btn btn-primary ">Voir le projet</a>

                        <a href="https://youtu.be/Wm_pZRckWAU" target="_blank" class="btn btn-success">Présentation vidéo</a>
                    </div>
